...
class Interface:
	...
	def __kernel_rem_pio2(self, x0,x1,x2,x3,x4,x5):
		return self.so.py___kernel_rem_pio2(ctypes.byref(ctypes.c_double(x0)), ctypes.byref(ctypes.c_double(x1)), ctypes.c_int(x2), ctypes.c_int(x3), ctypes.c_int(x4), ctypes.byref(ctypes.c_int(x5)))
